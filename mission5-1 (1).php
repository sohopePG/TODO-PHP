...
<body>
      ...
      <form action="" method="post">
        ...
        <input type="text" name="comment" placeholder="コメント"value ="<?php echo $editcomment?>"required> <br>
        <input type="text" name="name" placeholder="name"value ="<?php echo $editname?>"required><br>
        <input type="password" name="password" placeholder="パスワード"required>
        <input type="submit" name="submit"><br>
        【削除フォーム】<br>
        <input type="number" name="delete" placeholder ="削除対象番号"><br>
        <input type="password" name="passwordn"placeholder="パスワード"required>
        <input type="submit" name="submi" value="削除"><br>
        【編集フォーム】<br>
        <input type="number" name="edit" placeholder="編集対象番号"><br>
        <input type="password" name="passworde"placeholder="パスワード"required>
